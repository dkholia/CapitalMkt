 ...
 * @see com.dcsoft.capmkt.orm.Student
...
public class StudentHome {
	...
	public Student findById(int id) {
		...
		try {
			Student instance = (Student) sessionFactory.getCurrentSession().get("com.dcsoft.capmkt.orm.Student", id);
			if (instance == null) {
	...
	public List<Student> findByExample(Student instance) {
		...
		try {
			List<Student> results = (List<Student>) sessionFactory.getCurrentSession()
					.createCriteria("com.dcsoft.capmkt.orm.Student").add(create(instance)).list();
