 ...
 * @see com.dcsoft.capmkt.orm.Course
...
public class CourseHome {
	...
	public Course findById(int id) {
		...
		try {
			Course instance = (Course) sessionFactory.getCurrentSession().get("com.dcsoft.capmkt.orm.Course", id);
			if (instance == null) {
	...
	public List<Course> findByExample(Course instance) {
		...
		try {
			List<Course> results = (List<Course>) sessionFactory.getCurrentSession()
					.createCriteria("com.dcsoft.capmkt.orm.Course").add(create(instance)).list();
